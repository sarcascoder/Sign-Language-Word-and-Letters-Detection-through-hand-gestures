...
class handDetector():
    ...
    find_position(img, draw=True): Returns the position of hand landmarks in the image and optionally draws the hand landmarks
    '''
    ...
    def find_position(self, img, draw=True):
        '''
        Returns the position of hand landmarks in the image and optionally draws the hand landmarks
        ...
        Returns:
        all_landmarks (list): A list of lists containing the id and coordinates (x, y) of each hand landmark for each hand
        '''
