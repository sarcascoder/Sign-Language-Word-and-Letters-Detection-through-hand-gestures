...
def main():
    ...
    lmlist = []  # Initialize lmlist to avoid potential reference errors
    ...
    while True:
        ...
        if landmarks and len(landmarks) == 1:
            ...
            if max_prob > confidence_threshold:
                ...
                cv2.putText(img, predicted_letter, (p1[0], p1[1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 255, 255), 3)
        ...
        if key == ord('c') and landmarks and len(landmarks) == 1:
            for item in lmlist:
    ...
    if signal_data and any(signal_data.values()):
